...
-- STRAIGHT TRANSLATION of the old hyprland.conf (hyprlang). Behavior is intended
-- to be identical; only the syntax changed. No settings were added or tuned.
-- See hyprland.recommended.lua for a version with upstream's current defaults.
...
-- local menu                = "rofi -theme ~/.config/rofi/fullscreen_theme.rasi -show combi -modes combi -combi-modes \"drun\""
-- local menu                = "walker"
-- local windowSwitch        = "walker -m windows"
...
hl.config({
    dwindle = {
        -- NOTE: the `pseudotile` master switch from the old config no longer exists.
        -- Pseudotiling is now per-window: hl.dsp.window.pseudo() or a window rule.
...
-- hl.bind(mainMod .. " + Backspace", hl.dsp.layout("togglesplit")) -- dwindle

hl.bind(mainMod .. " + Z",      hl.dsp.exec_cmd(webBrowser))
hl.bind(mainMod .. " + Insert", hl.dsp.exec_cmd(notification))
hl.bind("Print",                hl.dsp.exec_cmd(screenshot))
hl.bind("CTRL + Print",         hl.dsp.exec_cmd(screenshotClipboard))
hl.bind(mainMod .. " + Tab",    hl.dsp.exec_cmd(windowSwitch))
hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd(lock))
-- hl.bind(mainMod .. " + Escape", hl.dsp.exec_cmd(showKeyBindings))
